...
const Login: React.FC = () => {
  ...
  return (
    // ... (Mantenha o JSX visual igual, pode remover a div de {error && ...} antiga se quiser)
              ...
              <div className="flex items-center justify-center">
                <form onSubmit={handleSubmit} className="flex w-full max-w-md flex-col items-center gap-8">
                  ...
                  <div className="flex w-full flex-col gap-6">
                    <div className="flex w-full flex-col gap-4">
                      ...
                      <label className="flex flex-col">
                        <div className="flex items-center justify-between pb-2">
                          ...
                          <Link to="/forgot-password" class="text-sm font-medium text-primary hover:underline">Esqueci minha senha</Link>
                        </div>
                        <div className="flex w-full flex-1 items-stretch rounded-lg">
                          <div className="text-slate-500 dark:text-slate-400 flex items-center justify-center rounded-l-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900/40 pl-4 border-r-0">
                    ...
                    <button type="submit" disabled={loading} className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 w-full bg-primary text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 dark:focus:ring-offset-background-dark transition-all disabled:opacity-70">
